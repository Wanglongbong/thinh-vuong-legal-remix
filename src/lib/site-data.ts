...
export const teamMembers: TeamMember[] = [
  {
    ...
    tasks: [
      '1. Nội dung: Chương III, Chương IV, Chương V Điều lệ công ty',
  ...
  },
  {
    ...
    evaluation: 'B',
    tasks: [
      '1. Nội dung: Chương 2 - Điều lệ công ty; Rủi ro & Xử lý',
      '2. Thuyết trình',
    ],
  },
  {
    ...
    evaluationNote: 'Top 30% đóng góp xuất sắc',
    tasks: [
      '1. Nội dung: Quy định chung - HĐ mở và sử dụng Ví điện tử',
      'Cảnh báo khi sử dụng dịch vụ Ví điện tử',
      'Nội dung & Vai trò quan trọng của Hợp đồng mở và sử dụng',
    ],
  },
  {
    name: 'Lê Phương Thảo',
    ...
    evaluation: 'B',
    tasks: [
      '1. Nội dung: Chương 1 - Điều lệ công ty',
      'Nội dung & Vai trò quan trọng của Điều lệ công ty',
    ],
  },
  {
    name: 'Vũ Anh Quân',
  ...
  },
  {
    ...
    evaluation: 'B',
    tasks: [
      '1. Nội dung: Chương 7 - Hiệu lực thanh toán',
      '2. Xây dựng rủi ro & giải pháp',
    ],
  },
  {
    name: 'Phạm Dạ Thảo',
    ...
    evaluationNote: 'Top 30% đóng góp xuất sắc',
    tasks: [
      '1. Nội dung: Chương 4 - Điều lệ công ty',
      'Quy định cổ đông nước ngoài & đầu tư nước ngoài',
  ...
  },
  {
    ...
    evaluation: 'C',
    tasks: [
      '1. Nội dung: Tiện ích của Ví điện tử',
    ],
  },
  {
    name: 'Phạm Văn Quang',
    ...
    evaluation: 'B',
    tasks: [
      '1. Nội dung: Cảnh báo các loại hình lừa đảo trực tuyến (HĐ bảo mật thông tin)',
      '2. Thuyết trình',
    ],
  },
  {
    ...
    evaluation: 'B',
    tasks: [
      '1. Nội dung: Thông tin khách hàng - HĐ mở và sử dụng',
      'Hướng dẫn giao dịch an toàn trên ứng dụng',
      'Ý tưởng / giải pháp bảo vệ quyền và lợi ích hợp pháp của DN',
    ],
  },
  {
  ...
  },
  {
    ...
    evaluation: 'B',
    tasks: [
      'Nội dung: Chương 6 - Điều lệ công ty',
      'Ý tưởng / giải pháp bảo vệ quyền và lợi ích hợp pháp của DN',
    ],
  },
];
