      ...
      {isTvpayOfficial ? (
        <section className="content-section py-8">
          <div className="site-shell max-w-7xl mx-auto">
            ...
            {/* Optional secondary report accordion or download if available */}
            {report && (
              <div className="mt-12 pt-8 border-t border-slate-200">
                <details className="p-4 bg-white border border-slate-200 rounded-xl">
                  <summary className="font-bold text-sm text-slate-800 cursor-pointer">
                    📊 Xem thêm: Báo cáo phân tích chuyên sâu &amp; Dự thảo mẫu
                  </summary>
                  <div className="mt-4">
                    <ContractReport content={report} />
                  </div>
                </details>
              </div>
            )}
